...
**Dexterity**: This ability measures the character's quickness and balance as well as his aptitude with tools. Dexterity is a prime requisite for assassins, bards, explorers, and thieves. A character's Dexterity bonus or penalty is applied to his attack throws with missile weapons, Armor Class value, and Initiative die rolls. When a character makes a proficiency throw to open locks, pick pockets, find traps, remove traps, hide in shadows, move silently, or climb walls, apply his DEX modifier to the roll. The bonuses does not apply to hijinks.   
